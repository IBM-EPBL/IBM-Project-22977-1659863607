...
alter table TrainTabl
add (SourceStation varchar(100), DestinationStation varchar(100));
alter table TrainTabl 
add(City varchar(100));

desc TrainTabl; 
select * from traintabl;

insert into TrainTabl(train_id, train_name, startTime, endTime, monday, tuesday, wednesday, thursday, friday, saturday, sunday, SourceStation, DestinationStation, City)
