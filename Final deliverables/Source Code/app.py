...
app.config["MYSQL_PASSWORD"] = "swetha123"
...
def home():
    if(request.method == 'POST'):
        ...
        img.save('C:\\Users\\sweth\\Downloads\\Train-ticket-booking-system-main\\Train-ticket-booking-system-main\\Swetha project\\static\\image\\qrcode.jpg')
        filename = 'qrcode.jpg'
